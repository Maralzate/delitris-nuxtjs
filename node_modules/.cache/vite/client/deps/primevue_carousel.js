import {
  Ripple
} from "./chunk-ISOBIHO2.js";
import {
  BaseStyle,
  useStyle
} from "./chunk-NHWI5CQD.js";
import {
  DomHandler,
  ObjectUtils,
  UniqueComponentId
  ...
  computed: {
    ...
    defaultPT: function defaultPT() {
      ...
      return this._getPT((_this$$config9 = this.$config) === null || _this$$config9 === void 0 ? void 0 : _this$$config9.pt, void 0, function(value2) {
        return _this3._getOptionValue(value2, _this3.$name, _objectSpread({}, _this3.$params)) || ObjectUtils.getItemValue(value2, _objectSpread({}, _this3.$params));
      });
    },
    ...
    $_attrsPT: function $_attrsPT() {
      return Object.entries(this.$attrs || {}).filter(function(_ref7) {
        ...
        var _ref10 = _slicedToArray(_ref9, 2), key = _ref10[0], value2 = _ref10[1];
    ...
    $_attrsNoPT: function $_attrsNoPT() {
      return Object.entries(this.$attrs || {}).filter(function(_ref11) {
        ...
        var _ref14 = _slicedToArray(_ref13, 2), key = _ref14[0], value2 = _ref14[1];
        acc[key] = value2;
        return acc;
      }, {});
    }
...
var _hoisted_25 = ["disabled", "aria-label"];
...
function render5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread3(_objectSpread3({}, _ctx.prevButtonProps), _ctx.ptm("previousButton")), {
  ...
  })], 16, _hoisted_25)), [[_directive_ripple]]) : createCommentVNode("", true), createBaseVNode("div", mergeProps({
  ...
  }, _objectSpread3(_objectSpread3({}, _ctx.nextButtonProps), _ctx.ptm("nextButton")), {
    "data-pc-group-section": "navigator"
  ...
  })], 16, _hoisted_5)), [[_directive_ripple]]) : createCommentVNode("", true)], 16, _hoisted_15), $options.totalIndicators >= 0 && _ctx.showIndicators ? (openBlock(), createElementBlock("ul", mergeProps({
    key: 0,
